...
contract LaLoHotelTokenizationTest is Test {
    ...
    function testTokenization() public {
        ...
        assertEq(
            tokenization.getAvailableTokens(0),
            900,
        ...
        assertEq(
            tokenization.getCurrentTokens(0),
            100,
        ...
        assertEq(
            tokenization.getCollectedRevenues(0),
            0,
        ...
        assertEq(
          tokenization.getAvailableRevenues(0),
          90,
          "Available revenues should match"
        );

        assertEq(
          tokenization.getRemainingPromisedRevenues(0),
          910,
          "Available revenues should match"
        );
